#!/usr/bin/env python3
"""
Extract unique contacts from a Gmail Takeout .mbox (Sent Mail only) into hubspot_contacts.csv.

Usage:
    python extract_contacts.py path/to/my_sent_mail.mbox
...
def main():
    ...
    parser.add_argument('mbox_path', help='Path to Gmail Takeout .mbox file (Sent Mail)')
    ...
    contacts, stats = extract_contacts(args.mbox_path)
